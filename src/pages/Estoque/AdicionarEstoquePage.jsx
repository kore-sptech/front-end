    ...
    return (
        <main className="h-screen w-full flex bg-[#000C24] overflow-hidden">
            ...
            <section className="grow h-full overflow-auto">
                <div className="p-6 flex w-full justify-between">
                    <div className="breadcrumbs text-sm">
                        <ul>
                            ...
                            <li><a onClick={() => navigate(`/estoque/${id}`)}>ESTOQUE</a></li>
                            <li><a><u>ADICIONAR ESTOQUE</u></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="p-6 flex w-full justify-center gap-8">

                    <fieldset className="fieldset bg-[#0A1A3D] rounded-box grow max-w-2xl p-6">
