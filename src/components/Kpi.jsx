...
export default function Kpi(props) {
  return (
    <div className="font-Roboto relative flex h-35 flex-col justify-around rounded-2xl border border-white/10 bg-[#061639] p-4.5 text-xs font-bold text-white">
      ...
      <img
        src={props.icone}
        alt="icone"
        className="absolute mb-16 ml-[80%] h-10 w-10"
      />
    </div>
  );
}
