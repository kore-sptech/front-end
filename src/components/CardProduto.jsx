...
export default function CardProduto(props) {
    ...
    return (
        <div className="card h-60 rounded-2xl bg-[#0A1A3D] w-55 shadow-sm mb-6 hover:cursor-pointer hover:shadow-cyan-300 hover:transition-all transition-all"
            ...
            <svg className="absolute right-1 top-1 hover:border-cyan-300" width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
