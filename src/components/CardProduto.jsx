...
export default function CardProduto(props) {
    ...
    return (
        <div className="card h-65 rounded-2xl bg-[#0A1A3D] w-80 shadow-sm mb-6 hover:cursor-pointer hover:shadow-cyan-300 hover:transition-all transition-all"
            ...
            <svg className="absolute right-1 top-1 border rounded-sm border-transparent transition-all hover:border-cyan-300" onClick={(e) => {
                e.stopPropagation();
            ...
            <p className="text-sm font-semibold absolute px-4 py-2 bg-[#263457] rounded-tl-2xl rounded-br-2xl">{props.tipo}</p>
            ...
            <div className="card-body h-auto flex-col justify-between items-center text-center">
                ...
                <div className="card-actions justify-between gap-7 items-center">
                    <div className="badge bg-[#48dbfc1a] ">
                        <p className="text-[#48DCFC]">Quantidade: {props.quantidade}</p>
                    </div>
                </div>
            </div>
        </div>
